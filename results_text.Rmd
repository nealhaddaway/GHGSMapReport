...
intervdata$all_interv <- gsub('N/A', '', intervdata$all_interv)
...
flowchart <- ROSES_flowchart(dbresults = '38,325',
                ...
                ftincl = '347',
                ftexcl <- data.frame(reason = c('Relevant review', 'Population', 'Intervention', 'Comparator', 'Outcome', 'Study design', 'Duplicate', 'Language', 'Superseded'), n = c('48', '825', '49', '68', '69', '188', '35', '127', '16')),
                prescreened = '2',
                studart <- c('349', '536'),
                finalmapincl = '536',
                type = 'map')
...
``` {r intervplot, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Intervention types investigated in the studies within the systematic map: a) the number of studies investigating each type of intervention, and b) the number of intervention types investigated across studies.", fig.show="hold", out.width="50%", results = "hide", fig.keep = 'all'}
par(mfrow=c(2,1))
...
``` {r outcomeyear, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Measured outcomes across all studies by the final study measurement year.", results = "hide", fig.keep = 'all'}
...
``` {r bubbleplot, echo=FALSE, fig.cap="Bubble plot of intervention type against sstudy country and measured outcome for studies in the systematic map. n indicates the number of studies. Countries coloured by continent", fig.dim = c(12, 10), warning=FALSE, messages=FALSE, results = "hide", fig.keep = 'all'}
source('bubbleplot.R')
...
bubbleplot <- bubbleplot(x_var = summdat$all_interv, 
          ...
          size_to = 6,
          interactive = FALSE) +
    ggplot2::theme(axis.text.y = ggplot2::element_text(colour = c(rep("#bea6b2", 1), rep("#85a8bb", 3), rep("#bea6b2", 12), rep("#85a8bb", 1), rep("#bea6b2", 2), rep("#85a8bb", 2), rep("#bea6b2", 3))))
