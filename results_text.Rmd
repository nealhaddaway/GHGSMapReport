...
data$expdesorder <- factor(data$experimental_design, levels=c("Purposive", "Paired design", "Split/strip plot", "Latin square", "Randomised", "Randomised complete block", "Unclear", "Not reported"))
...
ggplot2::ggplot(data = data, 
                           ggplot2::aes(x = expdesorder)) +
  ggplot2::geom_bar(stat = "count",
                    color = 'White', 
                    fill = '#8CB3B0') + 
  ggplot2::theme_minimal() +
  ggplot2::scale_x_discrete(limits = rev(levels(data$expdesorder))) +
  ggplot2::coord_flip() + 
  ggplot2::stat_count(geom = "text", colour = "#8CB3B0", size = 3.5,
                      ggplot2::aes(label = ..count..), 
