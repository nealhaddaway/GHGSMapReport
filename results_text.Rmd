...
**Season (for studies <1 year):** For studies lasting less than 1 year (n = `r nrow(below12months)`), the median study length was `r median(as.numeric(below12months$total_months))` months (see Figure \@ref(fig:studylength2)).
